                                ...
                                <div class="control-group"> 
                                    <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="post">
                                        ...
                                        <div class="controls">
                                            ...
                                            <input type="radio" name="jenis_kelamin" value="Tidak Diketahui"> Tidak Diketahui 
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="span12">
  							<table class="table">
						        ...
						        <tr>
						            ...
						            <td>
                                        <a class="btn btn-warning" href="pertemuan_12.php?id=<?php echo $data['id']; ?>"> Edit </a>  
                                        | 
                                        <a class="btn btn-danger" href="hapus_data.php?id=<?php echo $data['id']; ?>"> Hapus </a>
                                    </td>
						        </tr>
